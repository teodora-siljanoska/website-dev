...
function Timeline({ data }: P): JSX.Element {
  return (
      ...
      <VerticalTimeline>
        {data.map((item, index) => (
          <VerticalTimelineElement
            key={index}
            className=""
            // style={.vertical-timeline-element-content{box-shadow: 0px 10px 10px 0px #ebdd5eb}}
          ...
          >
            <div className="pb-2 text-xl font-['Mont-bold'] text-purple">
              {item.title}
            </div>
            {item.title && <hr className="border-lightGrey" />}
            <div className="text-lg">
              <div className="pb-0 pt-2 font-['Mont-bold'] text-liliac">
                {item.secondTitle}
              </div>
              <div className="font-['Mont-light']"> {item.desc}</div>
            </div>
          </VerticalTimelineElement>
        ))}
      </VerticalTimeline>
